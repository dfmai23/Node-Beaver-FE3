// ======================================================================
// Node-Beaver_FE3.v generated from TopDesign.cysch
// 04/08/2017 at 07:19
...
`ifdef WARP
`define CY_BLK_DIR "D:\Programming\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_50"
`include "D:\Programming\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_50\B_SPI_Master_v2_50.v"
`else
`define CY_BLK_DIR "D:\Programming\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_50"
`include "D:\Programming\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_50\B_SPI_Master_v2_50.v"
`endif

// SPI_Master_v2_50(BidirectMode=false, ClockInternal=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DesiredBitRate=250000, HighSpeedMode=true, InternalClockUsed=1, InternalInterruptEnabled=0, InternalRxInterruptEnabled=0, InternalTxInterruptEnabled=1, InterruptOnByteComplete=false, InterruptOnRXFull=false, InterruptOnRXNotEmpty=false, InterruptOnRXOverrun=false, InterruptOnSPIDone=false, InterruptOnSPIIdle=false, InterruptOnTXEmpty=false, InterruptOnTXNotFull=true, IntOnByteComp=0, IntOnRXFull=0, IntOnRXNotEmpty=0, IntOnRXOver=0, IntOnSPIDone=0, IntOnSPIIdle=0, IntOnTXEmpty=0, IntOnTXNotFull=1, Mode=1, ModeUseZero=1, NumberOfDataBits=8, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, RxBufferSize=4, ShiftDir=0, TxBufferSize=64, UseInternalInterrupt=false, UseRxInternalInterrupt=false, UseTxInternalInterrupt=true, VerilogSectionReplacementString=sR8, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=SPI_Master_v2_50, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=xbee_spi, CY_INSTANCE_SHORT_NAME=xbee_spi, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=xbee_spi, )
module SPI_Master_v2_50_7 (
	...
	cy_clock_v1_0
		#(.id("b2ce99c7-8cd4-4a9d-8c70-40135115e35a/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("2000000000"),
		  .is_direct(0),
...
`ifdef WARP
`define CY_BLK_DIR "D:\Programming\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_constant_v1_0"
`include "D:\Programming\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_constant_v1_0\cy_constant_v1_0.v"
`else
`define CY_BLK_DIR "D:\Programming\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_constant_v1_0"
`include "D:\Programming\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_constant_v1_0\cy_constant_v1_0.v"
`endif
...
module top ;
	...
	wire [0:0] tmpOE__xbee_sclk_net;
	wire [0:0] tmpFB_0__xbee_sclk_net;
	wire [0:0] tmpIO_0__xbee_sclk_net;
	wire [0:0] tmpINTERRUPT_0__xbee_sclk_net;
	electrical [0:0] tmpSIOVREF__xbee_sclk_net;

	cy_psoc3_pins_v1_10
		#(.id("627bb29f-f0df-42ea-a94d-66a09712bc1d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		xbee_sclk
		 (.oe(tmpOE__xbee_sclk_net),
		  .y({Net_272}),
		  .fb({tmpFB_0__xbee_sclk_net[0:0]}),
		  .io({tmpIO_0__xbee_sclk_net[0:0]}),
		  .siovref(tmpSIOVREF__xbee_sclk_net),
		  .interrupt({tmpINTERRUPT_0__xbee_sclk_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__xbee_sclk_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__xbee_mosi_net;
	wire [0:0] tmpFB_0__xbee_mosi_net;
	wire [0:0] tmpIO_0__xbee_mosi_net;
	wire [0:0] tmpINTERRUPT_0__xbee_mosi_net;
	electrical [0:0] tmpSIOVREF__xbee_mosi_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		xbee_mosi
		 (.oe(tmpOE__xbee_mosi_net),
		  .y({Net_271}),
		  .fb({tmpFB_0__xbee_mosi_net[0:0]}),
		  .io({tmpIO_0__xbee_mosi_net[0:0]}),
		  .siovref(tmpSIOVREF__xbee_mosi_net),
		  .interrupt({tmpINTERRUPT_0__xbee_mosi_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__xbee_mosi_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__xbee_ss_net;
	wire [0:0] tmpFB_0__xbee_ss_net;
	wire [0:0] tmpIO_0__xbee_ss_net;
	wire [0:0] tmpINTERRUPT_0__xbee_ss_net;
	electrical [0:0] tmpSIOVREF__xbee_ss_net;

	cy_psoc3_pins_v1_10
		#(.id("0a97ef7e-d859-47c1-9c5c-edcd2fd09d7d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		xbee_ss
		 (.oe(tmpOE__xbee_ss_net),
		  .y({Net_273}),
		  .fb({tmpFB_0__xbee_ss_net[0:0]}),
		  .io({tmpIO_0__xbee_ss_net[0:0]}),
		  .siovref(tmpSIOVREF__xbee_ss_net),
		  .interrupt({tmpINTERRUPT_0__xbee_ss_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__xbee_ss_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ZeroTerminal ZeroTerminal_2 (
        .z(Net_200));

    Timer_v2_70_6 time_refresh_timer (
        .reset(Net_200),
        .interrupt(Net_248),
        .enable(1'b1),
        .trigger(1'b1),
        ...
        .tc(Net_235),
        .clock(Net_10));
    defparam time_refresh_timer.CaptureCount = 2;
    defparam time_refresh_timer.CaptureCounterEnabled = 0;
    ...
    SPI_Master_v2_50_7 xbee_spi (
        ...
        .clock(1'b0),
        .reset(Net_297),
        .rx_interrupt(Net_579),
        .sdat(Net_580),
        .tx_interrupt(Net_581));
    defparam xbee_spi.BidirectMode = 0;
    defparam xbee_spi.HighSpeedMode = 1;
    defparam xbee_spi.NumberOfDataBits = 8;
    defparam xbee_spi.ShiftDir = 0;

	wire [0:0] tmpOE__xbee_miso_net;
	wire [0:0] tmpIO_0__xbee_miso_net;
	wire [0:0] tmpINTERRUPT_0__xbee_miso_net;
	electrical [0:0] tmpSIOVREF__xbee_miso_net;

	cy_psoc3_pins_v1_10
		#(.id("84f093f9-e8b8-41f1-be8b-a7e7ddf504a4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		xbee_miso
		 (.oe(tmpOE__xbee_miso_net),
		  .y({1'b0}),
		  .fb({Net_274}),
		  .io({tmpIO_0__xbee_miso_net[0:0]}),
		  .siovref(tmpSIOVREF__xbee_miso_net),
		  .interrupt({tmpINTERRUPT_0__xbee_miso_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__xbee_miso_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_297 = 1'h0;


	cy_clock_v1_0
		#(.id("bc198165-55f8-4851-88d4-8540cdd8ab2b"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
