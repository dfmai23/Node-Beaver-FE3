...
module top ;
    ...
    defparam millis_timer.Resolution = 24;
    ...
    Timer_v2_70_2 time_refresh_timer (
        .reset(Net_18),
        .interrupt(Net_19),
        .enable(1'b1),
        .trigger(1'b1),
